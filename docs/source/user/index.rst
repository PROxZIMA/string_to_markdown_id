...
The simplest way to install String to Markdown Id is using Pip.

.. code-block:: console

    $ pip install string_to_markdown_id

This will install ``string_to_markdown_id`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/PROxZIMA/string_to_markdown_id/issues>`_.
